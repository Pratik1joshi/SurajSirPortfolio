export default function Footer() {
  return (
    <footer className="border-t py-6 md:py-8 bg-slate-50">
      <div className="container flex flex-col items-center justify-center gap-4 text-center md:gap-6">
        ...
        <p className="text-sm text-muted-foreground">© {new Date().getFullYear()} Suraj Gautam. All rights reserved.</p>
        <p className="text-xs text-muted-foreground">
          Disaster Risk Management Expert | Civil Engineer | GIS Specialist
        </p>
      </div>
    </footer>
  )
